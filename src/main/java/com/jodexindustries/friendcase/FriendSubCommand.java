...
public class FriendSubCommand implements SubCommand {
    ...
    public List<String> getTabCompletions(CommandSender sender, String[] args) {
        ...
        if(args.length == 1) {
            ...
            if(args.length == 2) {
                strings = new ArrayList<>(Case.getCasesConfig().getCases().keySet());
                return strings;
            }
        }
    ...
    public String[] getArgs() {
        ...
        for (String args : t.getConfig().getConfig().getStringList("Api.Args")) {
    ...
    public String getDescription() {
        return rc(t.getConfig().getConfig().getString("Api.Description"));
    }
}
